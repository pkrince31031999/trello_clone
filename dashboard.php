...
$getBoardData = $conn->prepare("SELECT * FROM boards WHERE created_by = ?");
$getBoardData->bind_param("s", $user_id);
$getBoardData->execute();
$boardData = $getBoardData->get_result();
            ...
            <div class="board-cards">
                ...
                <?php
                        if ($boardData->num_rows > 0) {
                            while ($board = $boardData->fetch_assoc()) {
                                echo '<a href="board.php?id=' . $board['id'] . '">
