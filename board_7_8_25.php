...
// Fetch the user details
    ...
    // //$user_id = $_SESSION['user_id'];
    // $boardName = $res['name'];
    // $boardDescription = $res['description'];
    // $boardId = $res['id'];
    // $is_archived = $res['is_archived'];

    // $stmt = $conn->prepare("SELECT * FROM cards WHERE board_id = ?");
    // $stmt->bind_param("i", $boardId);
    // $stmt->execute();
    // $res = $stmt->get_result();
...
<body>
    <header>
         <img src="./img/kaaryaHub_logo.png" alt="Logo" style="width: 150px; height: 100px;" />
    ...
    <div class="modal" id="createListModal">
        <div class="modal-content createlist">
            ...
            <div class="modal-left">
                ...
                <div class="members-section">
                    ...
                    <div class="members" id="members-list">
                        ...
                        <div class="board-members-dropdown" id="board-members-dropdown">
                            <div class="board-member-list" id="board-member-list">
                                <!-- Example member item -->
                                <div class="board-member-item" data-initials="RK" title="Rahul Kumar">Rahul Kumar</div>
                                <div class="board-member-item" data-initials="MG" title="Megha Gupta">Megha Gupta</div>
                                <div class="board-member-item" data-initials="VS" title="Vikas Singh">Vikas Singh</div>
                                <div class="board-member-item" data-initials="AK" title="Anita Kapoor">Anita Kapoor</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="button-layer">
                    <label class="attachment-btn">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" class="icon">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5l-5 5a3.5 3.5 0 01-5-5l7-7a4.5 4.5 0 116.5 6.5l-8 8a5.5 5.5 0 11-7.5-7.5l7.5-7.5" />
                        </svg>
                ...
                <div class="description">
                    ...
                    <div class="dummy-description" id="dummy-description">
                        This is a placeholder description for the task. It can include additional details about the task requirements, progress, or any other information relevant to the team.
                    </div>
                </div>
            </div>
            ...
            <div class="modal-right">
                ...
                <div class="activity-section">
                    ...
                    <div class="activity-log" id="activity-log">
                        <div class="activity-item">John updated the task.</div>
                        <div class="activity-item">Alice added a checklist.</div>
                    </div>
